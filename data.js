...
var przyslowia = ["A co po czyjej wielkości, jak nie ma w głowie mądrości.",
  ...
  "Drzwi mogą być albo otwarte, albo zamknięte; trzeciej możliwości nie",
  ...
  "Gdy Zielona Matka [15 VIII] deszcz przynosi, to zwykle na Narodzenie",
  ...
  "Głupi nie jest ten, co się głupim robi, ale ten, co swojej roboty nie",
  ...
  "Groźniejsze jest wojsko jeleni przy lwie hetmanie niż wojsko lwów przy",
  ...
  "Jaka marchew, taka nać – taka córka jaka mać, jakie drzewo, taki klin",
  ...
  "Kiedy Pan Bóg zamyka wszystkie drzwi, zawsze zostawia jakieś uchylone",
  ...
  "Kochanie gorzej jak więzienie: z więzienia wyzwolą, z kochania nie",
  ...
  "Kto ma dużo roli – ten się najada do woli, kto ma mórg niewiele – temu",
  ...
  "Lepiej żałować, że się coś zrobiło, niż żałować, że się nic nie",
  ...
  "Na Nowy Rok pogoda – będzie w polu uroda, na Nowy Rok pluta – będzie w",
  ...
  "Na Gromniczną mróz – ładuj chłopie wóz, na Gromniczną ciecze – to się",
  ...
  "Nie na to żyjemy, byśmy jedli i pili, lecz na to pijem i jemy, abyśmy",
  ...
  "Nie pomoże uczoność, ani nieskończoność, ani fura sprzętu, jak nie ma",
  "Nie przebieraj panno, żebyś nie przebrała, żebyś za kanarka wróbla nie",
  ...
  "Nigdy nie jest tak źle, żeby nie mogło być gorzej, ani tak dobrze,",
  "Nigdy nie mów „nigdy”.",
  ...
  "Pan Bóg stworzył byka – i byk był; a chłop wziął kozika, urżnął mu u",
  ...
  "Prawa są równie jako pajęczyna: wróbel się przeciśnie, a na muszkę",
  ...
  "Śniadanie zjedz sam, obiadem podziel się z przyjacielem, a kolację daj",
  "Śpiesz się powoli.",
  ...
  "Zawodu szewca trzeba się wyuczyć, a do wyższych stanowisk wystarczy",
  ...
  "Jeśli na Agnieszkę pochmurno, to o len nie trudno; a jeśli jasno, to o",
  ...
  "Na św. Franciszka zielenią się łany i ze swego zimowiska wracają",
  "Na św. Grzegorza zima idzie do morza.",
  "Od św. Agnieszki już posprzątaj z drzew liszki, a jeśli mróz tęgi,",
  ...
  "W dzień św. Agaty, jeśli słonko przez okienko zajrzy do chaty, to",
...
var cytaty = [
  ...
  "Gdy życie ci zbrzydło i stało się piekłem, wsadź łeb do sedesu i nakryj się deklem.  (ref.) Łaaa!  Gdy żona cię nudzi, a babka dobija, to kup flaszkę w sklepie i zalej se ryja!  (ref.) Łaaa!  PIT-y, NIP-y, REGON-y, wszystko papier popieprzony, urzędowe te wezwania, papier tylko do wysrania!",
  ...
  "– Halincia, śpisz?  – No śpię, bo co?  – Bo ogóra kiszonego bym se zjadł. Halincia, są w domu jakieś ogórki?  – Ferdek, do jasnej cholery, jest trzecia w nocy. Nie zawracaj mi dupy jakimś zasranym ogórem kiszonym, a jak chcesz to idź do kuchni i sobie weź. A mi daj spać.  – Halincia! Mogłabyś pójść do kuchni i przynieść mi ogórka kiszonego?  A dobra, sam se pójdę.",
  ...
  "Siekiera, motyka, baba goła, Marian Paździoch to pierdoła.  Siekiera, motyka, bum-cyk-cyk, Marian Paździoch – stary pryk.  Siekiera, motyka, smętna bajka, u Paździocha miętka fajka.  Siekiera, motyka, małpi wuj, Marian Paździoch to jest chuj.",
  ...
  "– Stać!  – Co jest, kurde?!  – Kto idzie?!  – Ferdynand Kiepski!  – Dobrze... Dokąd się wybiera?!  – Do kibla!  – Siku czy kupę?!  – A... gówno to pana obchodzi, panie Paździoch!",
...
var maksymy = [
  ...
  "сколько ни тужить, обо всём не перетужить",
  "скучен день до вечера, коли делать нечего",
  "снявши голову, по волосам не плачут",
  "старый конь борозды не испортит",
  "то ли лыжи не едут, то ли я ебанутый",
  "только мокро останется",
